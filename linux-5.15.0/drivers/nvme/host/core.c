...
blk_status_t nvme_setup_cmd(struct nvme_ns *ns, struct request *req)
{
	...
	case REQ_OP_ZONE_MODIFY:
		ret = nvme_setup_zone_mgmt_send(ns, req, cmd, NVME_ZONE_MODIFY_ZONE);
		break;
	case REQ_OP_ZONE_RRZONE:
		ret = nvme_setup_zone_mgmt_recv(ns, req, cmd, NVME_ZONE_REPORT_RZONE);
		break;
	case REQ_OP_ZONE_R_BLOCK_ERASE:
		ret = nvme_setup_zone_mgmt_send(ns, req, cmd, NVME_ZONE_R_BLOCK_ERASE);
		break;
	case REQ_OP_ZONE_R_LINE_ERASE:
		ret = nvme_setup_zone_mgmt_send(ns, req, cmd, NVME_ZONE_R_LINE_ERASE);
		break;
