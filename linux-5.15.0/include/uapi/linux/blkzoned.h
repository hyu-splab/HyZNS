...
/**
 * struct blk_rzone_report - BLKREPORTABA ioctl request/reply
 * @data: Received data from device (u32 value)
 *
 * Used to receive reduced zone report data from the device.
 */
struct blk_rzone_report {
	__u32		data;
};
...
#define BLKUPDATEABA	_IOW(0x12, 137, __u32) //1074795145
#define BLKREPORTABA	_IOR(0x12, 138, struct blk_rzone_report)
