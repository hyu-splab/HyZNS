...
class Runner(object):
    ...
    def __init__(self, \
        ...
        self.MEDIA_TYPES   = ["nvme"]
#        self.FS_TYPES      = [
        self.FS_TYPES      = ["overlayfs",
                              #"tmpfs",
                              #"ext4", "ext4_no_jnl",
                              #"xfs",
                              #"btrfs", "f2fs",
        ...
        self.HOWTO_MOUNT = {
            ...
            "overlayfs":self.mount_overlayfs,
        }
        self.HOWTO_MKFS = {
            "ext2":"-F",
            "ext3":"-F",
...
#self.set_cpus(ncore)
    ...
    def mount_overlayfs(self, media, fs, mnt_path):
                    ...
                    for dio in self.DIRECTIOS:
                        for fs in self.FS_TYPES:
                            ...
                            if not mount_fn:
                                continue
                            #print(self.FILTER)
                            #print((media, fs, bench, str(ncore), dio))
                            if self._match_config(self.FILTER, (media, fs, bench, str(ncore), dio)):
...
if __name__ == "__main__":
    ...
    run_config = [
    #(Runner.CORE_FINE_GRAIN, PerfMon.LEVEL_LOW,("nvme", "overlayfs", "DWOL", "1", "bufferedio")),
    #(Runner.CORE_FINE_GRAIN, PerfMon.LEVEL_LOW,("nvme", "overlayfs", "MWRL", "1", "bufferedio")),
    #(Runner.CORE_FINE_GRAIN, PerfMon.LEVEL_LOW,("nvme", "overlayfs", "DWAL", "16", "bufferedio")),
    #(Runner.CORE_FINE_GRAIN, PerfMon.LEVEL_LOW,("nvme", "overlayfs", "DRBL", "32", "bufferedio")),
    #(Runner.CORE_FINE_GRAIN, PerfMon.LEVEL_LOW,("nvme", "overlayfs", "DWOL", "1", "bufferedio")),
    
    #(Runner.CORE_FINE_GRAIN, PerfMon.LEVEL_LOW,("nvme", "overlayfs", "MRPL", "16", "directio")),
    #(Runner.CORE_FINE_GRAIN, PerfMon.LEVEL_LOW,("nvme", "overlayfs", "MRDL", "16", "directio")),
    (Runner.CORE_FINE_GRAIN, PerfMon.LEVEL_LOW,("nvme", "overlayfs", "MWCL", "16", "directio")),
    #(Runner.CORE_FINE_GRAIN, PerfMon.LEVEL_LOW,("nvme", "overlayfs", "MWRL", "16", "directio")),
    #(Runner.CORE_FINE_GRAIN, PerfMon.LEVEL_LOW,("nvme", "overlayfs", "DWOL", "16", "directio")),
