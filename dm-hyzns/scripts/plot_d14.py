...
Reads dm-hyzns/results/<csv> (or first arg) and writes an SVG showing
...
CSV = sys.argv[1] if len(sys.argv) > 1 else \
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "results", "d14_first_cut_20260505_1518.csv")
