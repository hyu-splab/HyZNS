...
#
#     MODE=hyzns  (default) FEMU HyZNS: aux F2FS on the R-region of the
#                 dm-hyzns stack, ZenFS on the S-region. This is the
...
#                 of the SAME physical SSD. No dm-hyzns. Logged as mode=zn540
...
MODE=${MODE:-hyzns}                   # hyzns (FEMU dm-hyzns) | real/zn540 (real SSD)
REAL=0
...
BACKING=${BACKING:-/dev/nvme0n1}      # FEMU HyZNS namespace
