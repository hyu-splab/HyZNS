#!/bin/bash
# Paper Fig.12a (fillrandom) and Fig.12b (overwrite) — L0 placement with the
...
#   L0_res_CNS   (L0_CNS_daemon)  L0 on CNS, hyznsd FTR grows it on demand
...
echo "done -> hyznsd/$OUT (fig144_fr = Fig.12a, fig144_ow = Fig.12b, + plot CSVs)"
