...
static Property femu_props[] = {
    ...
    /* HYZNS (femu_mode=5) geometry. Defaults: 8ch x 4way x 128 pg/blk x
    ...
    DEFINE_PROP_INT32("hyzns_nchs", FemuCtrl, hyzns_params.nchs, 8),
    DEFINE_PROP_INT32("hyzns_luns_per_ch", FemuCtrl, hyzns_params.luns_per_ch, 4),
    DEFINE_PROP_INT32("hyzns_page_bytes", FemuCtrl, hyzns_params.page_bytes, 16384),
    DEFINE_PROP_INT32("hyzns_pgs_per_blk", FemuCtrl, hyzns_params.pgs_per_blk, 128),
    DEFINE_PROP_INT32("hyzns_zone_size_mb", FemuCtrl, hyzns_params.zone_size_mb, 1024),
