...
num_rzones=8   # must be ( 1 < x < blks_per_pl )

FEMU_OPTIONS_HY2="-device femu"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",devsz_mb=${ssd_size_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",namespaces=1"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",femu_mode=4"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",secsz=${secsz_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",secs_per_pg=${secs_per_pg_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",pgs_per_blk=${pgs_per_blk_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",blks_per_pl=${blks_per_pl_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",pls_per_lun=${pls_per_lun_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",luns_per_ch=${luns_per_ch_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",nchs=${nchs_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",pg_rd_lat=${pg_rd_lat_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",pg_wr_lat=${pg_wr_lat_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",blk_er_lat=${blk_er_lat_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",ch_xfer_lat=${ch_xfer_lat_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",gc_thres_pcent=${gc_thres_pcent_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",gc_thres_pcent_high=${gc_thres_pcent_high_hy}"
FEMU_OPTIONS_HY2=${FEMU_OPTIONS_HY2}",num_rzones=${num_rzones}"
#-----------------------------------------------------------------------
# Hybrid-SSD (HYSSD) SSDs Controller layout parameters

num_rzones=16   # must be ( 1 < x < blks_per_pl )

FEMU_OPTIONS_HY3="-device femu"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",devsz_mb=${ssd_size_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",namespaces=1"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",femu_mode=4"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",secsz=${secsz_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",secs_per_pg=${secs_per_pg_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",pgs_per_blk=${pgs_per_blk_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",blks_per_pl=${blks_per_pl_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",pls_per_lun=${pls_per_lun_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",luns_per_ch=${luns_per_ch_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",nchs=${nchs_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",pg_rd_lat=${pg_rd_lat_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",pg_wr_lat=${pg_wr_lat_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",blk_er_lat=${blk_er_lat_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",ch_xfer_lat=${ch_xfer_lat_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",gc_thres_pcent=${gc_thres_pcent_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",gc_thres_pcent_high=${gc_thres_pcent_high_hy}"
FEMU_OPTIONS_HY3=${FEMU_OPTIONS_HY3}",num_rzones=${num_rzones}"
#-----------------------------------------------------------------------
# Hybrid-SSD (HYSSD) SSDs Controller layout parameters

num_rzones=32   # must be ( 1 < x < blks_per_pl )

FEMU_OPTIONS_HY4="-device femu"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",devsz_mb=${ssd_size_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",namespaces=1"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",femu_mode=4"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",secsz=${secsz_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",secs_per_pg=${secs_per_pg_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",pgs_per_blk=${pgs_per_blk_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",blks_per_pl=${blks_per_pl_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",pls_per_lun=${pls_per_lun_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",luns_per_ch=${luns_per_ch_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",nchs=${nchs_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",pg_rd_lat=${pg_rd_lat_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",pg_wr_lat=${pg_wr_lat_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",blk_er_lat=${blk_er_lat_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",ch_xfer_lat=${ch_xfer_lat_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",gc_thres_pcent=${gc_thres_pcent_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",gc_thres_pcent_high=${gc_thres_pcent_high_hy}"
FEMU_OPTIONS_HY4=${FEMU_OPTIONS_HY4}",num_rzones=${num_rzones}"
#-----------------------------------------------------------------------

echo ${FEMU_OPTIONS_BB}
echo ${FEMU_OPTIONS_ZNS}
echo ${FEMU_OPTIONS_HY}
echo ${FEMU_OPTIONS_HY2}
echo ${FEMU_OPTIONS_HY3}
echo ${FEMU_OPTIONS_HY4}
