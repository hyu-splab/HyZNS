#!/bin/bash
#
# debug-dual-gdb.sh [hyhost|zns]   (default: hyhost)
#
...
#
#   ./debug-dual-gdb.sh hyhost     # run-hyhost-dual.sh under gdb
...
MODE="${1:-hyhost}"
case "$MODE" in
    hyhost) SRC="run-hyhost-dual.sh" ;;
    zns)    SRC="run-zns-dual.sh" ;;
    *) echo "usage: $0 {hyhost|zns}" >&2; exit 1 ;;
esac
