...
CPL=(pkgdep.sh femu-compile.sh _femu_tune.sh measure-setup.sh pin-threads.sh debug-dual-gdb.sh run-whitebox.sh run-blackbox.sh run-nossd.sh run-zns.sh run-hyzns.sh run-hyzns-dual.sh run-zns-dual.sh pin.sh ftk)
